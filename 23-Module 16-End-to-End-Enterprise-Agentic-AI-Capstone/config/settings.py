...
def apply_streamlit_secrets(secrets: dict) -> None:
    """Copy Streamlit Cloud secrets into os.environ before the workflow runs."""
...
def configure_langsmith() -> None:
    ...
    os.environ.setdefault("LANGSMITH_PROJECT", "lab23_capstone")
    ...
    os.environ["LANGCHAIN_PROJECT"] = os.environ.get("LANGSMITH_PROJECT", "lab23_capstone")
